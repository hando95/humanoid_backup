    ...
    while True:
        ...
        if len(cnts) > 0:
            ...
            if Area > min_area[now_color]:
                ...
                TX_data(serial_port, now_color)
                if now_color == 0:
                    cv2.putText(frame, "Yellow!", (50, int(H_View_size / 2)),
                    cv2.FONT_HERSHEY_PLAIN, 5, (255, 255, 255), thickness=5)
                if now_color == 1:
                    cv2.putText(frame, "Red!", (50, int(H_View_size / 2)),
                    cv2.FONT_HERSHEY_PLAIN, 5, (255, 255, 255), thickness=5)
                if now_color == 2:
                    cv2.putText(frame, "Blue!", (50, int(H_View_size / 2)),
                    cv2.FONT_HERSHEY_PLAIN, 5, (255, 255, 255), thickness=5)
                if now_color == 3:
                    cv2.putText(frame, "Green!", (50, int(H_View_size / 2)),
                    cv2.FONT_HERSHEY_PLAIN, 5, (255, 255, 255), thickness=5)
                if now_color == 4:
                    cv2.putText(frame, "Black!", (50, int(H_View_size / 2)),
                    cv2.FONT_HERSHEY_PLAIN, 5, (255, 255, 255), thickness=5)
                #----------------------------------------
